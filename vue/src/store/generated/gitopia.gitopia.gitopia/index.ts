...
import { Bounty } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
import { ExercisedAmount } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
import { DistributionProportion } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
import { PoolProportions } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
import { Params } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
import { QueryGetPullRequestRequest } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
import { QueryGetPullRequestResponse } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
import { Reaction } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
import { IssueIid } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
import { PullRequestIid } from "gitopia-gitopia-client-ts/gitopia.gitopia.gitopia/types"
...
export { Attachment, Bounty, Branch, Comment, Dao, ExercisedAmount, Issue, Member, DistributionProportion, PoolProportions, Params, PullRequest, PullRequestHead, PullRequestBase, QueryGetPullRequestRequest, QueryGetPullRequestResponse, IssueOptions, PullRequestOptions, RepositoryFork, Reaction, Release, Repository, RepositoryId, BaseRepositoryKey, RepositoryOwner, IssueIid, PullRequestIid, RepositoryCollaborator, RepositoryLabel, RepositoryRelease, RepositoryBackup, Tag, Task, MsgDeleteStorageProviderResponse, MsgSetBranch_Branch, MsgMultiSetBranch_Branch, MsgSetTag_Tag, MsgMultiSetTag_Tag, User, UserDao, Whois };
...
const getDefaultState = () => {
	return {
				...
				_Structure: {
						...
						Bounty: getStructure(Bounty.fromPartial({})),
						Branch: getStructure(Branch.fromPartial({})),
						Comment: getStructure(Comment.fromPartial({})),
						Dao: getStructure(Dao.fromPartial({})),
						ExercisedAmount: getStructure(ExercisedAmount.fromPartial({})),
						Issue: getStructure(Issue.fromPartial({})),
						Member: getStructure(Member.fromPartial({})),
						DistributionProportion: getStructure(DistributionProportion.fromPartial({})),
						PoolProportions: getStructure(PoolProportions.fromPartial({})),
						...
						QueryGetPullRequestRequest: getStructure(QueryGetPullRequestRequest.fromPartial({})),
						QueryGetPullRequestResponse: getStructure(QueryGetPullRequestResponse.fromPartial({})),
						...
						Reaction: getStructure(Reaction.fromPartial({})),
						...
						IssueIid: getStructure(IssueIid.fromPartial({})),
						PullRequestIid: getStructure(PullRequestIid.fromPartial({})),
...
export default {
	...
	getters: {
				getVestedAmount: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.VestedAmount[JSON.stringify(params)] ?? {}
		},
			...
			return state.MemberAll[JSON.stringify(params)] ?? {}
				...
				getBounty: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.Bounty[JSON.stringify(params)] ?? {}
		},
				getBountyAll: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.BountyAll[JSON.stringify(params)] ?? {}
		},
			...
			return state.DaoAll[JSON.stringify(params)] ?? {}
				...
				getIssueComment: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.IssueComment[JSON.stringify(params)] ?? {}
		},
				getPullRequestComment: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.PullRequestComment[JSON.stringify(params)] ?? {}
		},
			...
			return state.CommentAll[JSON.stringify(params)] ?? {}
				...
				getIssueCommentAll: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.IssueCommentAll[JSON.stringify(params)] ?? {}
		},
				getPullRequestCommentAll: (state) => (params = { params: {}}) => {
					if (!(<any> params).query) {
						(<any> params).query=null
					}
			return state.PullRequestCommentAll[JSON.stringify(params)] ?? {}
		},
	...
	actions: {
		...
		async QueryVestedAmount({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryVestedAmount( key.address)).data
				
					
				commit('QUERY', { query: 'VestedAmount', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryVestedAmount', payload: { options: { all }, params: {...key},query }})
				return getters['getVestedAmount']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryVestedAmount API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryBounty({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryBounty( key.id)).data
				
					
				commit('QUERY', { query: 'Bounty', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryBounty', payload: { options: { all }, params: {...key},query }})
				return getters['getBounty']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryBounty API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryBountyAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryBountyAll(query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.GitopiaGitopiaGitopia.query.queryBountyAll({...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'BountyAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryBountyAll', payload: { options: { all }, params: {...key},query }})
				return getters['getBountyAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryBountyAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryIssueComment({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryIssueComment( key.repositoryId,  key.issueIid,  key.commentIid)).data
				
					
				commit('QUERY', { query: 'IssueComment', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryIssueComment', payload: { options: { all }, params: {...key},query }})
				return getters['getIssueComment']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryIssueComment API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryPullRequestComment({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryPullRequestComment( key.repositoryId,  key.pullRequestIid,  key.commentIid)).data
				
					
				commit('QUERY', { query: 'PullRequestComment', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryPullRequestComment', payload: { options: { all }, params: {...key},query }})
				return getters['getPullRequestComment']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryPullRequestComment API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryIssueCommentAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryIssueCommentAll( key.repositoryId,  key.issueIid, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.GitopiaGitopiaGitopia.query.queryIssueCommentAll( key.repositoryId,  key.issueIid, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'IssueCommentAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryIssueCommentAll', payload: { options: { all }, params: {...key},query }})
				return getters['getIssueCommentAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryIssueCommentAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryPullRequestCommentAll({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryPullRequestCommentAll( key.repositoryId,  key.pullRequestIid, query ?? undefined)).data
				
					
				while (all && (<any> value).pagination && (<any> value).pagination.next_key!=null) {
					let next_values=(await client.GitopiaGitopiaGitopia.query.queryPullRequestCommentAll( key.repositoryId,  key.pullRequestIid, {...query ?? {}, 'pagination.key':(<any> value).pagination.next_key} as any)).data
					value = mergeResults(value, next_values);
				}
				commit('QUERY', { query: 'PullRequestCommentAll', key: { params: {...key}, query}, value })
				if (subscribe) commit('SUBSCRIBE', { action: 'QueryPullRequestCommentAll', payload: { options: { all }, params: {...key},query }})
				return getters['getPullRequestCommentAll']( { params: {...key}, query}) ?? {}
			} catch (e) {
				throw new Error('QueryClient:QueryPullRequestCommentAll API Node Unavailable. Could not perform query: ' + e.message)
		...
		async QueryPullRequestMergePermission({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				const key = params ?? {};
				const client = initClient(rootGetters);
				let value= (await client.GitopiaGitopiaGitopia.query.queryPullRequestMergePermission( key.userId,  key.repositoryId,  key.pullIid)).data
		...
		async sendMsgUpdateRepositoryBackupRef({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateRepositoryBackupRef({ value, fee: fullFee, memo })
				return result
			} catch (e) {
		...
		async sendMsgRemoveIssueLabels({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemoveIssueLabels({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateDaoLocation({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateDaoLocation({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateTask({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateTask({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateComment({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateComment({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddMember({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddMember({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateIssue({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateIssue({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRevokeProviderPermission({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRevokeProviderPermission({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgToggleIssueState({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgToggleIssueState({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateDaoAvatar({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateDaoAvatar({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateRepositoryLabel({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateRepositoryLabel({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateRelease({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateRelease({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRemovePullRequestLabels({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemovePullRequestLabels({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateDaoDescription({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateDaoDescription({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgInvokeMergePullRequest({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgInvokeMergePullRequest({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreatePullRequest({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreatePullRequest({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdatePullRequestDescription({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdatePullRequestDescription({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateBountyExpiry({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateBountyExpiry({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgUpdateBountyExpiry:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgUpdateBountyExpiry:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgUpdateDaoWebsite({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateDaoWebsite({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgInvokeForkRepository({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgInvokeForkRepository({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteUser({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteUser({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteTag({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteTag({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteBounty({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteBounty({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgDeleteBounty:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgDeleteBounty:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgUpdateMemberRole({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateMemberRole({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRenameRepository({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRenameRepository({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateUserUsername({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateUserUsername({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgExercise({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgExercise({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgExercise:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgExercise:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgRemovePullRequestReviewers({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemovePullRequestReviewers({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateUser({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateUser({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCloseBounty({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCloseBounty({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCloseBounty:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgCloseBounty:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgAddRepositoryBackupRef({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddRepositoryBackupRef({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteTask({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteTask({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgForkRepositorySuccess({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgForkRepositorySuccess({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateBounty({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateBounty({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCreateBounty:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgCreateBounty:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgUpdatePullRequestTitle({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdatePullRequestTitle({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateTask({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateTask({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgSetDefaultBranch({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgSetDefaultBranch({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRemoveMember({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemoveMember({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateRepositoryLabel({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateRepositoryLabel({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUnlinkPullRequestIssueByIid({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUnlinkPullRequestIssueByIid({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgUnlinkPullRequestIssueByIid:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgUnlinkPullRequestIssueByIid:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgDeleteBranch({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteBranch({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteRepository({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteRepository({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRemoveRepositoryCollaborator({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemoveRepositoryCollaborator({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateUserAvatar({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateUserAvatar({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgToggleForcePush({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgToggleForcePush({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgToggleForcePush:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgToggleForcePush:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgChangeOwner({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgChangeOwner({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgSetBranch({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgSetBranch({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateRepositoryCollaborator({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateRepositoryCollaborator({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgMultiSetBranch({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgMultiSetBranch({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRemoveIssueAssignees({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemoveIssueAssignees({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgSetPullRequestState({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgSetPullRequestState({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateUserBio({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateUserBio({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateRepositoryDescription({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateRepositoryDescription({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteRepositoryLabel({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteRepositoryLabel({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgLinkPullRequestIssueByIid({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgLinkPullRequestIssueByIid({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgLinkPullRequestIssueByIid:Init Could not initialize signing client. Wallet is required.')
				}else{
					throw new Error('TxClient:MsgLinkPullRequestIssueByIid:Send Could not broadcast Tx: '+ e.message)
				}
			}
		},
		async sendMsgUpdateIssueTitle({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateIssueTitle({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgSetTag({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgSetTag({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgMultiSetTag({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgMultiSetTag({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteIssue({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteIssue({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeletePullRequest({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeletePullRequest({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateDao({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateDao({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgForkRepository({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgForkRepository({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAuthorizeProvider({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAuthorizeProvider({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateComment({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateComment({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteComment({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteComment({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateIssueDescription({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateIssueDescription({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteRelease({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteRelease({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgMultiDeleteTag({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgMultiDeleteTag({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRenameDao({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRenameDao({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgUpdateUserName({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgUpdateUserName({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgMultiDeleteBranch({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgMultiDeleteBranch({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddPullRequestAssignees({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddPullRequestAssignees({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateRelease({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateRelease({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddPullRequestReviewers({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddPullRequestReviewers({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgToggleRepositoryForking({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgToggleRepositoryForking({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddIssueLabels({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddIssueLabels({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgCreateRepository({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgCreateRepository({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddPullRequestLabels({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddPullRequestLabels({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgRemovePullRequestAssignees({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgRemovePullRequestAssignees({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgDeleteDao({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgDeleteDao({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgToggleArweaveBackup({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgToggleArweaveBackup({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async sendMsgAddIssueAssignees({ rootGetters }, { value, fee = {amount: [], gas: "200000"}, memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const fullFee = Array.isArray(fee)  ? {amount: fee, gas: "200000"} :fee;
				const result = await client.GitopiaGitopiaGitopia.tx.sendMsgAddIssueAssignees({ value, fee: fullFee, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgUpdateBountyExpiry({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgUpdateBountyExpiry({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgUpdateBountyExpiry:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgUpdateBountyExpiry:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgDeleteBounty({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgDeleteBounty({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgDeleteBounty:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgDeleteBounty:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgExercise({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgExercise({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgExercise:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgExercise:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgCloseBounty({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgCloseBounty({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCloseBounty:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgCloseBounty:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgCreateBounty({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgCreateBounty({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgCreateBounty:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgCreateBounty:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgUnlinkPullRequestIssueByIid({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgUnlinkPullRequestIssueByIid({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgUnlinkPullRequestIssueByIid:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgUnlinkPullRequestIssueByIid:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgToggleForcePush({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgToggleForcePush({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgToggleForcePush:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgToggleForcePush:Create Could not create message: ' + e.message)
				}
			}
		},
		...
		async MsgLinkPullRequestIssueByIid({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.GitopiaGitopiaGitopia.tx.msgLinkPullRequestIssueByIid({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgLinkPullRequestIssueByIid:Init Could not initialize signing client. Wallet is required.')
				} else{
					throw new Error('TxClient:MsgLinkPullRequestIssueByIid:Create Could not create message: ' + e.message)
				}
			}
		},
