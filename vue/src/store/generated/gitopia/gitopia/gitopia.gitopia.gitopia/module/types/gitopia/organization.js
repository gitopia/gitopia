...
export const Organization = {
    encode(message, writer = Writer.create()) {
        ...
        Object.entries(message.repositories).forEach(([key, value]) => {
            Organization_RepositoriesEntry.encode({ key: key, value }, writer.uint32(58).fork()).ldelim();
        });
        ...
        Object.entries(message.members).forEach(([key, value]) => {
            Organization_MembersEntry.encode({ key: key, value }, writer.uint32(74).fork()).ldelim();
        });
        if (message.location !== "") {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    const entry7 = Organization_RepositoriesEntry.decode(reader, reader.uint32());
                ...
                case 8:
                    ...
                    break;
                case 9:
                    const entry9 = Organization_MembersEntry.decode(reader, reader.uint32());
...
const baseOrganization_RepositoriesEntry = { key: "", value: 0 };
