...
import { MsgUpdateOrganizationWebsite } from "./types/gitopia/tx";
...
import { MsgUpdateOrganizationLocation } from "./types/gitopia/tx";
...
const types = [
  ...
  ["/gitopia.gitopia.gitopia.MsgUpdateOrganizationWebsite", MsgUpdateOrganizationWebsite],
  ...
  ["/gitopia.gitopia.gitopia.MsgUpdateOrganizationLocation", MsgUpdateOrganizationLocation],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgUpdateOrganizationWebsite: (data: MsgUpdateOrganizationWebsite): EncodeObject => ({ typeUrl: "/gitopia.gitopia.gitopia.MsgUpdateOrganizationWebsite", value: MsgUpdateOrganizationWebsite.fromPartial( data ) }),
    ...
    msgUpdateOrganizationLocation: (data: MsgUpdateOrganizationLocation): EncodeObject => ({ typeUrl: "/gitopia.gitopia.gitopia.MsgUpdateOrganizationLocation", value: MsgUpdateOrganizationLocation.fromPartial( data ) }),
