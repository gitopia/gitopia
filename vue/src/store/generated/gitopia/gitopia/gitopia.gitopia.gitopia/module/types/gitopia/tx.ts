...
export const MsgUpdateRequest = {
  encode(message: MsgUpdateRequest, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgUpdateRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgUpdateRequest } as MsgUpdateRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
const baseMsgUpdateRequestResponse: object = {};

export const MsgUpdateRequestResponse = {
  encode(
    _: MsgUpdateRequestResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgUpdateRequestResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgUpdateRequestResponse,
    } as MsgUpdateRequestResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgUpdateRequestResponse>
  ): MsgUpdateRequestResponse {
    const message = {
      ...baseMsgUpdateRequestResponse,
    } as MsgUpdateRequestResponse;
...
const baseMsgChangeRequestState: object = { creator: "", id: 0, state: "" };
...
export const MsgChangeRequestState = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgChangeRequestState {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgChangeRequestState } as MsgChangeRequestState;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgChangeRequestState>
  ): MsgChangeRequestState {
    const message = { ...baseMsgChangeRequestState } as MsgChangeRequestState;
    if (object.creator !== undefined && object.creator !== null) {
      message.creator = object.creator;
    } else {
...
const baseMsgChangeRequestStateResponse: object = {};

export const MsgChangeRequestStateResponse = {
  encode(
    _: MsgChangeRequestStateResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgChangeRequestStateResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgChangeRequestStateResponse,
    } as MsgChangeRequestStateResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgChangeRequestStateResponse>
  ): MsgChangeRequestStateResponse {
    const message = {
      ...baseMsgChangeRequestStateResponse,
    } as MsgChangeRequestStateResponse;
...
const baseMsgDeleteRequest: object = { creator: "", id: 0 };

export const MsgDeleteRequest = {
  encode(message: MsgDeleteRequest, writer: Writer = Writer.create()): Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgDeleteRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseMsgDeleteRequest } as MsgDeleteRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
const baseMsgDeleteRequestResponse: object = {};

export const MsgDeleteRequestResponse = {
  encode(
    _: MsgDeleteRequestResponse,
    writer: Writer = Writer.create()
  ): Writer {
    return writer;
  },
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number
  ): MsgDeleteRequestResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgDeleteRequestResponse,
    } as MsgDeleteRequestResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(
    _: DeepPartial<MsgDeleteRequestResponse>
  ): MsgDeleteRequestResponse {
    const message = {
      ...baseMsgDeleteRequestResponse,
    } as MsgDeleteRequestResponse;
...
export interface Msg {
  ...
  ): Promise<MsgChangeRequestStateResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  UpdateRequest(request: MsgUpdateRequest): Promise<MsgUpdateRequestResponse> {
    ...
    return promise.then((data) =>
      MsgUpdateRequestResponse.decode(new Reader(data))
    );
  }
  ...
  ChangeRequestState(
    ...
    return promise.then((data) =>
      MsgChangeRequestStateResponse.decode(new Reader(data))
    );
  }
  ...
  DeleteRequest(request: MsgDeleteRequest): Promise<MsgDeleteRequestResponse> {
    ...
    return promise.then((data) =>
      MsgDeleteRequestResponse.decode(new Reader(data))
    );
  }
