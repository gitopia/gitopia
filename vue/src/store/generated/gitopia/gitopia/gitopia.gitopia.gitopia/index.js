...
import { RequestOptions } from "./module/types/gitopia/query";
...
import { Request } from "./module/types/gitopia/request";
import { Requests } from "./module/types/gitopia/request";
...
const getDefaultState = () => {
    return {
        ...
        _Structure: {
            ...
            RequestOptions: getStructure(RequestOptions.fromPartial({})),
            ...
            Requests: getStructure(Requests.fromPartial({})),
...
export default {
    ...
    getters: {
        ...
        getRepositoryRequestAll: (state) => (params = { params: {} }) => {
            if (!params.query) {
                params.query = null;
            }
            return state.RepositoryRequestAll[JSON.stringify(params)] ?? {};
        },
        ...
        getAddressRequestReceivedAll: (state) => (params = { params: {} }) => {
            if (!params.query) {
                params.query = null;
            }
            return state.AddressRequestReceivedAll[JSON.stringify(params)] ?? {};
        },
    ...
    actions: {
        ...
        async QueryRequest({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryRequest(key.id)).data;
        ...
        async QueryRequestAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryRequestAll(query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryRequestAll({ ...query, 'pagination.key': value.pagination.nextKey })).data;
        ...
        async QueryRelease({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryRelease(key.id)).data;
                commit('QUERY', { query: 'Release', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRelease', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryReleaseAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryReleaseAll(query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryReleaseAll({ ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'ReleaseAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryReleaseAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryReleaseLatest({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryReleaseLatest', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryRelease({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryRelease', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryReleaseAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryRepositoryReleaseAll(key.userId, key.repositoryName, query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryRepositoryReleaseAll(key.userId, key.repositoryName, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'RepositoryReleaseAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryReleaseAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryIssue({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryIssue', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryIssueAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryRepositoryIssueAll(key.id, key.repositoryName, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'RepositoryIssueAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryIssueAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryPullRequest({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryPullRequest', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryPullRequestAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryRepositoryPullRequestAll(key.userId, key.repositoryName, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'RepositoryPullRequestAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryPullRequestAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryRepositoryRequestAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryRepositoryRequestAll(key.id, key.repositoryName, query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryRepositoryRequestAll(key.id, key.repositoryName, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'RepositoryRequestAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryRepositoryRequestAll', payload: { options: { all }, params: { ...key }, query } });
                return getters['getRepositoryRequestAll']({ params: { ...key }, query }) ?? {};
            }
            catch (e) {
                throw new SpVuexError('QueryClient:QueryRepositoryRequestAll', 'API Node Unavailable. Could not perform query: ' + e.message);
            }
        },
        ...
        async QueryForkAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryForkAll(key.userId, key.repositoryName, query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryForkAll(key.userId, key.repositoryName, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'ForkAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryForkAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryBranchSha({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryBranchSha', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryTagAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryTagAll(key.repositoryId)).data;
                commit('QUERY', { query: 'TagAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryTagAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryTagSha({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryTagSha', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryAddressRepositoryAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryAddressRepositoryAll(key.id, query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryAddressRepositoryAll(key.id, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'AddressRepositoryAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryAddressRepositoryAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryAddressRepository({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryAddressRepository', payload: { options: { all }, params: { ...key }, query } });
        ...
        async QueryAddressRequestReceivedAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                const queryClient = await initQueryClient(rootGetters);
                let value = (await queryClient.queryAddressRequestReceivedAll(key.address, query)).data;
                while (all && value.pagination && value.pagination.nextKey != null) {
                    let next_values = (await queryClient.queryAddressRequestReceivedAll(key.address, { ...query, 'pagination.key': value.pagination.nextKey })).data;
                    value = mergeResults(value, next_values);
                }
                commit('QUERY', { query: 'AddressRequestReceivedAll', key: { params: { ...key }, query }, value });
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryAddressRequestReceivedAll', payload: { options: { all }, params: { ...key }, query } });
                return getters['getAddressRequestReceivedAll']({ params: { ...key }, query }) ?? {};
            }
            catch (e) {
                throw new SpVuexError('QueryClient:QueryAddressRequestReceivedAll', 'API Node Unavailable. Could not perform query: ' + e.message);
            }
        },
        async QueryUserOrganizationAll({ commit, rootGetters, getters }, { options: { subscribe, all } = { subscribe: false, all: false }, params: { ...key }, query = null }) {
            try {
                ...
                if (subscribe)
                    commit('SUBSCRIBE', { action: 'QueryUserOrganizationAll', payload: { options: { all }, params: { ...key }, query } });
        ...
        async sendMsgChangeRequestState({ rootGetters }, { value, fee = [], memo = '' }) {
            try {
                const txClient = await initTxClient(rootGetters);
                const msg = await txClient.msgChangeRequestState(value);
                const result = await txClient.signAndBroadcast([msg], { fee: { amount: fee,
                        gas: "200000" }, memo });
                return result;
            }
                ...
                if (e == MissingWalletError) {
                    throw new SpVuexError('TxClient:MsgChangeRequestState:Init', 'Could not initialize signing client. Wallet is required.');
                }
                else {
                    throw new SpVuexError('TxClient:MsgChangeRequestState:Send', 'Could not broadcast Tx: ' + e.message);
                }
            }
        },
        ...
        async sendMsgCreateRequest({ rootGetters }, { value, fee = [], memo = '' }) {
            try {
                const txClient = await initTxClient(rootGetters);
                const msg = await txClient.msgCreateRequest(value);
                const result = await txClient.signAndBroadcast([msg], { fee: { amount: fee,
                        gas: "200000" }, memo });
                return result;
            }
                ...
                if (e == MissingWalletError) {
                    throw new SpVuexError('TxClient:MsgCreateRequest:Init', 'Could not initialize signing client. Wallet is required.');
                }
                else {
                    throw new SpVuexError('TxClient:MsgCreateRequest:Send', 'Could not broadcast Tx: ' + e.message);
                }
            }
        },
        ...
        async sendMsgDeleteRequest({ rootGetters }, { value, fee = [], memo = '' }) {
            try {
                const txClient = await initTxClient(rootGetters);
                const msg = await txClient.msgDeleteRequest(value);
                const result = await txClient.signAndBroadcast([msg], { fee: { amount: fee,
                        gas: "200000" }, memo });
                return result;
            }
                ...
                if (e == MissingWalletError) {
                    throw new SpVuexError('TxClient:MsgDeleteRequest:Init', 'Could not initialize signing client. Wallet is required.');
                }
                else {
                    throw new SpVuexError('TxClient:MsgDeleteRequest:Send', 'Could not broadcast Tx: ' + e.message);
                }
            }
        },
        ...
        async sendMsgUpdateRequest({ rootGetters }, { value, fee = [], memo = '' }) {
            try {
                const txClient = await initTxClient(rootGetters);
                const msg = await txClient.msgUpdateRequest(value);
                const result = await txClient.signAndBroadcast([msg], { fee: { amount: fee,
                        gas: "200000" }, memo });
                return result;
            }
                ...
                if (e == MissingWalletError) {
                    throw new SpVuexError('TxClient:MsgUpdateRequest:Init', 'Could not initialize signing client. Wallet is required.');
                }
                else {
                    throw new SpVuexError('TxClient:MsgUpdateRequest:Send', 'Could not broadcast Tx: ' + e.message);
                }
            }
        },
        ...
        async MsgChangeRequestState({ rootGetters }, { value }) {
            try {
                const txClient = await initTxClient(rootGetters);
                const msg = await txClient.msgChangeRequestState(value);
                return msg;
                ...
                if (e == MissingWalletError) {
                    ...
                    throw new SpVuexError('TxClient:MsgChangeRequestState:Create', 'Could not create message: ' + e.message);
                }
            }
        },
        ...
        async MsgCreateRequest({ rootGetters }, { value }) {
            try {
                ...
                if (e == MissingWalletError) {
                    ...
                    throw new SpVuexError('TxClient:MsgCreateRequest:Create', 'Could not create message: ' + e.message);
                }
            }
        },
        ...
        async MsgDeleteRequest({ rootGetters }, { value }) {
            try {
                ...
                if (e == MissingWalletError) {
                    ...
                    throw new SpVuexError('TxClient:MsgDeleteRequest:Create', 'Could not create message: ' + e.message);
                }
            }
        },
        ...
        async MsgUpdateRequest({ rootGetters }, { value }) {
            try {
                ...
                if (e == MissingWalletError) {
                    ...
                    throw new SpVuexError('TxClient:MsgUpdateRequest:Create', 'Could not create message: ' + e.message);
                }
            }
        },
