...
echo $OSMOSIS_E2E_RLY_MNEMONIC > /root/.hermes/OSMOSIS_E2E_RLY_MNEMONIC.txt
...
[[chains]]
id = '$OSMOSIS_E2E_CHAIN_ID'
rpc_addr = 'http://$OSMOSIS_E2E_VAL_HOST:26657'
grpc_addr = 'http://$OSMOSIS_E2E_VAL_HOST:9090'
event_source = { mode = 'push', url = 'ws://$OSMOSIS_E2E_VAL_HOST:26657/websocket' , batch_delay = '50ms' }
rpc_timeout = '10s'
account_prefix = 'osmo'
key_name = 'rly01-osmosis'
store_prefix = 'ibc'
max_gas =  6000000
...
# import keys
hermes keys add  --key-name rly01-osmosis  --chain $OSMOSIS_E2E_CHAIN_ID --mnemonic-file /root/.hermes/OSMOSIS_E2E_RLY_MNEMONIC.txt
sleep 5
