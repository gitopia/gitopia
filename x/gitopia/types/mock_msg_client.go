...
func (_m *MockMsgClient) InvokeForkRepository(ctx context.Context, in *MsgInvokeForkRepository, opts ...grpc.CallOption) (*MsgInvokeForkRepositoryResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *MsgInvokeForkRepositoryResponse
	if rf, ok := ret.Get(0).(func(context.Context, *MsgInvokeForkRepository, ...grpc.CallOption) *MsgInvokeForkRepositoryResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*MsgInvokeForkRepositoryResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *MsgInvokeForkRepository, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MultiSetRepositoryBranch provides a mock function with given fields: ctx, in, opts
...
// MultiSetRepositoryTag provides a mock function with given fields: ctx, in, opts
...
// RemoveDaoMember provides a mock function with given fields: ctx, in, opts
func (_m *MockMsgClient) RemoveMember(ctx context.Context, in *MsgRemoveMember, opts ...grpc.CallOption) (*MsgRemoveMemberResponse, error) {
	...
	var r0 *MsgRemoveMemberResponse
	if rf, ok := ret.Get(0).(func(context.Context, *MsgRemoveMember, ...grpc.CallOption) *MsgRemoveMemberResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*MsgRemoveMemberResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *MsgRemoveMember, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateDaoMember provides a mock function with given fields: ctx, in, opts
func (_m *MockMsgClient) UpdateMemberRole(ctx context.Context, in *MsgUpdateMemberRole, opts ...grpc.CallOption) (*MsgUpdateMemberRoleResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *MsgUpdateMemberRoleResponse
	if rf, ok := ret.Get(0).(func(context.Context, *MsgUpdateMemberRole, ...grpc.CallOption) *MsgUpdateMemberRoleResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*MsgUpdateMemberRoleResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *MsgUpdateMemberRole, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
type mockConstructorTestingTNewMockMsgClient interface {
	mock.TestingT
	Cleanup(func())
}
