...
func (_m *MockMsgClient) InvokeForkRepository(ctx context.Context, in *MsgInvokeForkRepository, opts ...grpc.CallOption) (*MsgInvokeForkRepositoryResponse, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for InvokeForkRepository")
	}

	var r0 *MsgInvokeForkRepositoryResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *MsgInvokeForkRepository, ...grpc.CallOption) (*MsgInvokeForkRepositoryResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
