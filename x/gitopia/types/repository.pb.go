...
type RepositoryBackupStore int32

const (
	RepositoryBackupStore_IPFS    RepositoryBackupStore = 0
	RepositoryBackupStore_ARWEAVE RepositoryBackupStore = 1
)

var RepositoryBackupStore_name = map[int32]string{
	0: "IPFS",
	1: "ARWEAVE",
}

var RepositoryBackupStore_value = map[string]int32{
	"IPFS":    0,
	"ARWEAVE": 1,
}

func (x RepositoryBackupStore) String() string {
	return proto.EnumName(RepositoryBackupStore_name, int32(x))
}

func (RepositoryBackupStore) EnumDescriptor() ([]byte, []int) {
...
type RepositoryBackup struct {
	Store RepositoryBackupStore `protobuf:"varint,1,opt,name=store,proto3,enum=gitopia.gitopia.gitopia.RepositoryBackupStore" json:"store,omitempty"`
...
func (m *RepositoryBackup) GetStore() RepositoryBackupStore {
	if m != nil {
		return m.Store
	}
...
func init() {
	proto.RegisterEnum("gitopia.gitopia.gitopia.RepositoryBackupStore", RepositoryBackupStore_name, RepositoryBackupStore_value)
...
var fileDescriptor_771033d6361900fa = []byte{
	...
	,
}
