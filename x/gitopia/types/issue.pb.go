...
type Issue struct {
	...
	AssigneesId  []string `protobuf:"bytes,12,rep,name=assigneesId,proto3" json:"assigneesId,omitempty"`
...
var fileDescriptor_4cf64e56e9098bda = []byte{
	...
	0x10, 0x86, 0x2d, 0xcb, 0x76, 0x22, 0x26, 0x4d, 0x53, 0x36, 0x68, 0x0f, 0x41, 0x21, 0x08, 0x99,
	0x84, 0x0e, 0xf6, 0xd0, 0x27, 0x68, 0xd0, 0xc5, 0xab, 0xc6, 0x6e, 0xb2, 0x78, 0x50, 0x08, 0xc8,
	0xa2, 0xaa, 0x3b, 0xa1, 0xf1, 0x5b, 0xf4, 0xb1, 0x3a, 0x66, 0x2c, 0xd0, 0xa5, 0xb0, 0x5f, 0xa4,
	0xe0, 0x49, 0x56, 0x9c, 0x4c, 0xbc, 0xff, 0xfb, 0xee, 0x00, 0x92, 0x38, 0xf5, 0xbe, 0xb4, 0xec,
	...
	0x5a, 0x1b, 0xb8, 0x94, 0xa1, 0x53, 0xa4, 0x3f, 0xa9, 0x48, 0x3e, 0x0c, 0xcd, 0x57, 0x86, 0x37,
	0x49, 0x90, 0x86, 0xd9, 0x33, 0xf0, 0xb6, 0x6b, 0xcc, 0x60, 0xaf, 0x7a, 0x3b, 0x02, 0x79, 0x71,
	0xe5, 0x48, 0xe4, 0x5b, 0x91, 0x63, 0x7e, 0x76, 0xf7, 0x3b, 0xb8, 0x96, 0xcf, 0x1a, 0xb3, 0x8e,
	0x95, 0xc2, 0x47, 0xc6, 0x9a, 0xac, 0xab, 0x09, 0xde, 0x89, 0x3d, 0x21, 0xf7, 0xdf, 0x7e, 0xef,
	0xe3, 0xe0, 0x69, 0x1f, 0x07, 0xff, 0xf6, 0x71, 0xf0, 0xeb, 0x10, 0x4f, 0x9e, 0x0e, 0xf1, 0xe4,
	0xcf, 0x21, 0x9e, 0x7c, 0xff, 0x5c, 0x5a, 0x7e, 0xe8, 0x36, 0xcb, 0xc2, 0x6d, 0x57, 0xc7, 0x35,
	0x3a, 0x9e, 0x8f, 0x63, 0xc5, 0xbb, 0x06, 0x69, 0xb3, 0x90, 0x55, 0xf9, 0xf2, 0x3f, 0x00, 0x00,
	0xff, 0xff, 0xa3, 0x69, 0x87, 0xee, 0x70, 0x02, 0x00, 0x00,
}
...
func (m *Issue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AssigneesId) > 0 {
		for iNdEx := len(m.AssigneesId) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintIssue(dAtA, i, uint64(len(m.AssigneesId[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
