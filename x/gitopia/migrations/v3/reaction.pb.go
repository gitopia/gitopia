...
type Reaction struct {
	...
	Emojis  []Emoji `protobuf:"varint,2,rep,packed,name=emojis,proto3,enum=gitopia.gitopia.gitopia.v3.Emoji" json:"emojis,omitempty"`
}
...
func init() {
	proto.RegisterEnum("gitopia.gitopia.gitopia.v3.Emoji", Emoji_name, Emoji_value)
	proto.RegisterType((*Reaction)(nil), "gitopia.gitopia.gitopia.v3.Reaction")
}
...
var fileDescriptor_6751c3791b2fecc0 = []byte{
	...
	0x2f, 0xc9, 0x17, 0x92, 0x82, 0x8a, 0xeb, 0xa1, 0xd3, 0x65, 0xc6, 0x52, 0x22, 0xe9, 0xf9, 0xe9,
	...
	0x97, 0xe7, 0x49, 0xb1, 0x74, 0x2c, 0x96, 0x63, 0x70, 0x0a, 0x3a, 0xf1, 0x48, 0x8e, 0xf1, 0xc2,
	...
	0xfa, 0x65, 0xc6, 0xd6, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0xe0, 0xe0, 0x31, 0x06, 0x04,
	0x00, 0x00, 0xff, 0xff, 0xa6, 0x6f, 0xb3, 0xf4, 0x6a, 0x01, 0x00, 0x00,
}
