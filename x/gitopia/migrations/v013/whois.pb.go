...
type Whois_OwnerType int32

const (
	Whois_USER         Whois_OwnerType = 0
	Whois_ORGANIZATION Whois_OwnerType = 1
)

var Whois_OwnerType_name = map[int32]string{
	0: "USER",
	1: "ORGANIZATION",
}

var Whois_OwnerType_value = map[string]int32{
	"USER":         0,
	"ORGANIZATION": 1,
}

func (x Whois_OwnerType) String() string {
	return proto.EnumName(Whois_OwnerType_name, int32(x))
}

func (Whois_OwnerType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_eb936eb6838a72a6, []int{0, 0}
}
...
type Whois struct {
	...
	OwnerType Whois_OwnerType `protobuf:"varint,4,opt,name=ownerType,proto3,enum=gitopia.gitopia.gitopia.Whois_OwnerType" json:"ownerType,omitempty"`
}
...
func (m *Whois) GetOwnerType() Whois_OwnerType {
	if m != nil {
		return m.OwnerType
	}
	return Whois_USER
...
func init() {
	// proto.RegisterEnum("gitopia.gitopia.gitopia.Whois_OwnerType", Whois_OwnerType_name, Whois_OwnerType_value)
...
var fileDescriptor_eb936eb6838a72a6 = []byte{
	...
	,
	...
	0x19, 0xa5, 0x49, 0x7a, 0xc9, 0xf9, 0xb9, 0xfa, 0xb0, 0xb0, 0x82, 0xd1, 0x15, 0x70, 0x56, 0x49,
	0x65, 0x41, 0x6a, 0x71, 0x12, 0x1b, 0x38, 0x3c, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x94,
	0x0b, 0x26, 0x83, 0x55, 0x01, 0x00, 0x00,
}
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OwnerType |= Whois_OwnerType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
