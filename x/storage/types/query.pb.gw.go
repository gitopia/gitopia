...
var (
	filter_Query_LFSObjectUpdateProposal_0 = &utilities.DoubleArray{Encoding: map[string]int{"repository_id": 0, "user": 1}, Base: []int{1, 1, 2, 0, 0}, Check: []int{0, 1, 1, 2, 3}}
)
...
func request_Query_LFSObjectUpdateProposal_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_LFSObjectUpdateProposal_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
var (
	...
	pattern_Query_LFSObjectUpdateProposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3, 1, 0, 4, 1, 5, 4}, []string{"gitopia", "storage", "lfs-object-update-proposal", "repository_id", "user"}, "", runtime.AssumeColonVerbOpt(false)))
