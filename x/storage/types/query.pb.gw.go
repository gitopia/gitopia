...
var (
	...
	pattern_Query_ProviderRewardsAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2}, []string{"gitopia", "storage", "provider-rewards-all"}, "", runtime.AssumeColonVerbOpt(false)))
)
